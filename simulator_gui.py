...
from PyQt5.QtWidgets import (QApplication, QCheckBox, QComboBox, QDialog, QGridLayout, QGroupBox, QHBoxLayout, QLabel, QLineEdit,
        ...
        QVBoxLayout, QWidget, QDoubleSpinBox, QFileDialog, QAction, QScrollArea, QFrame)
...
class MPI_Simulator_GUI(QDialog):
    ...
    def __init__(self, numNetworkFactors=0, numHWFactors=0):
        super().__init__()
...
class Starter_GUI(QDialog):
    ...
    def __init__(self):
        ...
        self.numNetLabel.setBuddy(self.numHWLabel)
...
if __name__ == '__main__':
    ...
    MAIN_GUI = MPI_Simulator_GUI(1, 2)
    MAIN_GUI.show()
